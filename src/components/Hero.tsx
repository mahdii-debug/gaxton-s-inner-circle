    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a 
            href="https://x.com/GaxTon" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-5 py-3 rounded-full border border-border/50 bg-card/40 backdrop-blur-sm mb-10 animate-fade-up hover:border-primary/30 hover:bg-card/60 transition-all duration-300 group"
          >
            ...
            <div className="text-left">
              ...
              <span className="text-xs text-muted-foreground">@GaxTon</span>
            </div>
            <div className="ml-2 text-xs text-muted-foreground border-l border-border/50 pl-3">
              <span className="text-foreground font-medium">12.4K</span> followers
            </div>
          </a>
